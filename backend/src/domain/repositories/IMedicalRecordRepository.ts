import type { MedicalRecord, CreateMedicalRecordData, UpdateMedicalRecordData } from "../entities/MedicalRecord";
...
export interface IMedicalRecordRepository {
  ...
  findAll(pagination?: PaginationQuery): Promise<MedicalRecord[]>;
