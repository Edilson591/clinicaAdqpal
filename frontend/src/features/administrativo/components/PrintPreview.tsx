...
export function PrintPreview({ document, values, contentRef }: PrintPreviewProps) {
  ...
  return (
    <section className="rounded-xl border border-[#E2E8F0] bg-white p-4 shadow-sm dark:border-[#334155] dark:bg-[#1E293B] sm:p-6 print:border-0 print:bg-white print:p-0 print:shadow-none">
      ...
      <div className="overflow-auto rounded-lg bg-[#F8FAFC] p-4 dark:bg-[#0F172A] print:overflow-visible print:bg-white print:p-0">
        <div ref={contentRef}>
