...
import { Save, User, Lock, FileText, Briefcase, MapPin } from "lucide-react";
  ...
  return (
    <FormContent>
      ...
      <FormHeader
        ...
        description="Preencha os dados para criar um novo acesso ao sistema"
      />
        ...
        <form onSubmit={onSubmit} noValidate className="flex flex-col gap-6">
          ...
          <div className="flex items-start gap-3">
            <input
              ...
              {...register("isEmployee")}
            />
            <label htmlFor="isEmployee" className="cursor-pointer select-none">
              <p className="text-sm font-medium text-[#1E293B] dark:text-[#F1F5F9]">
                Este usuário também é um funcionário da clínica
              </p>
              <p className="text-xs text-[#94A3B8] mt-0.5">
                Ao marcar, será criado um registro de funcionário vinculado a
                este usuário
              </p>
            </label>
          </div>
