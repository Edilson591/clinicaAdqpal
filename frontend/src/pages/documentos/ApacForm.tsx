...
export function ApacForm({
  ...
  const CNS_LENGTH_OR_CPF_MED = data.f43_doc === "cpf" ? 11 : 15;
  const CNS_LENGTH_OR_CPF_AUTO = data.f48_doc === "cpf" ? 11 : 15;
  return (
      ...
      <div className="max-h-[calc(100dvh-18rem)] w-full overflow-auto print:max-h-none print:overflow-visible">
        <div className="flex min-w-max justify-center pb-2 print:min-w-0 print:pb-0">
          <div
            ref={formRef}
            id="apac-form"
            className="apac-page w-198.5 max-w-none shrink-0 p-[3mm] bg-white text-[10pt] font-sans flex flex-col shadow-sm overflow-hidden print:w-full print:shrink"
          >
            {/* HEADER SUS */}
                ...
                >
                  ...
                  <div className="flex-4 border-r border-black flex flex-col">
                    ...
                    <input
                      ...
                      value={sp.nome}
                      onChange={(e) =>
                        updateSecProc(idx, "nome", e.target.value)
                      }
                      className="apac-input text-[9.5pt]"
                    />
                  </div>
                  <div className="max-w-12 flex flex-col">
                    ...
                    <input
                      ...
                      value={sp.qtde}
                      onChange={(e) =>
                        updateSecProc(idx, "qtde", e.target.value)
                      }
                      className="apac-input text-[9.5pt]"
                    />
                  </div>
